...
cp "$out/yosys_cluster_synthesis.log" "$root/results_hpca_xorflow/artifact_runs/decoder/decoder_cluster_rtl_synthesis.log"
cp "$out/verilator_cluster_lint.log" "$root/results_hpca_xorflow/artifact_runs/decoder/decoder_cluster_verilator_lint.log"
cp "$out/decoder_cluster_cosim.log" "$root/results_hpca_xorflow/artifact_runs/decoder/decoder_cluster_cosim.log"
echo "$out"
