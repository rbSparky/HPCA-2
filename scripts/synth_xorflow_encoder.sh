...
# artifact, and its synthesis scope is recorded as RTL elaboration.
...
cp "$out/yosys_encoder_synthesis.log" "$root/results_hpca_xorflow/artifact_runs/encoder/encoder_rtl_synthesis.log"
cp "$out/yosys_encoder_engine_synthesis.log" "$root/results_hpca_xorflow/artifact_runs/encoder/encoder_engine_rtl_synthesis.log"
cp "$out/yosys_encoder_stream_synthesis.log" "$root/results_hpca_xorflow/artifact_runs/encoder/encoder_stream_rtl_synthesis.log"
cp "$out/verilator_encoder_lint.log" "$root/results_hpca_xorflow/artifact_runs/encoder/encoder_verilator_lint.log"
echo "$out"
