...
yosys -p "read_verilog -sv $root/rtl/xorflow_encoder_pipelined.sv; hierarchy -check -top xorflow_encoder_tile_engine; proc; opt; techmap; opt; abc -g simple; clean; stat" > "$out/yosys_encoder_engine_synthesis.log"
